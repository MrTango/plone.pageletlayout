...
def upgrade(context):
    ...
    customised since install. Since 1004 the file holds the elements' places
    in the stock managers instead of the whole-body order.
    """
    logger.info("Re-importing the viewlets step: stock hidden set")
